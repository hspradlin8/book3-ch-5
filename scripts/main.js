// Lightning Exercise:
//  1.Add another section sibling to the current one and use object dot notation
//   to display each company's city. 
//  2. Use square bracket notation to display the state code. 
//  3. Use dynamic square bracket notation to add the zip code.
...
//line 131 square bracket notation
...
//   that has the full name of the purchasing agent, the company name, 
//   and the phone number. 
//   The data structure is shown below. 
//   Use that new data structure to display the agent with their company and phone number
...
console.log("successful companies", bigSpenders);